...
// Construir otro método
        otrometodo:function(parametro1){
            let numero = 8;
            console.log("La suma es: " + (numero+parametro1));
        }
    };
    return objPersona;
}
let varObjReg = constructor(); //crear la variable llamada Objeto, dentro de 
